...
// import w3 from "../assets/web3.svg";
    ...
    <div className="shrink gap-5 sm:gap-12 flex flex-row !flex-wrap w-87% sm:w-auto overflow-scroll">
      <div className="shrink sm:w-128 sm:h-32 h-24 bg-white rounded-lg flex flex-col gap-1 sm:gap-2 justify-center items-center py-1 ">
        ...
        <div className="shrink flex flex-row gap-1 sm:gap-2 px-2">
          ...
          <div className="shrink bg-yellow-300 rounded-full w-10px h-10px text-transparent">
            {" "}
            .
          </div>{" "}
          <div className="shrink bg-yellow-200 rounded-full w-10px h-10px text-transparent">
            {" "}
            .
          </div>{" "}
      ...
      <div className="shrink  sm:h-32  sm:w-32 h-24 bg-white rounded-lg flex flex-col gap-1 sm:gap-2 justify-center items-center py-1 shadow-lg">
      ...
      <div className="shrink sm:w-32 sm:h-32  h-24 bg-white rounded-lg flex flex-col gap-1 sm:gap-2 justify-center items-center py-1 shadow-lg">
        ...
        <div className="shrink flex flex-row gap-1 sm:gap-2 px-2">
          ...
          <div className="shrink rounded-full w-10px h-10px text-transparent flex flex-row">
            <div className="shrink bg-yellow-200 rounded-l-full w-1/2 h-10px text-transparent ">
              .
            </div>
            <div className="shrink bg-gray-200 rounded-r-full w-1/2 h-10px text-transparent ">
              .
            </div>
          </div>
          <div className="shrink bg-gray-200 rounded-full w-10px h-10px text-transparent"> .</div>
