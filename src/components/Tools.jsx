...
function tools() {
  return (
    <div className="sm:gap-12  gap-5 flex flex-row flex-wrap flex-shrink">
      <div className="sm:w-[128px] sm:h-32 h-24  bg-white rounded-lg flex flex-col gap-1 sm:gap-2 justify-center items-center py-1 shadow-lg">
        <h1 className="flex flex-col text-center font-bold leading-[14px] sm:text-sm text-xs sm:w-24 flex-wrap w-14">
          Google Suite
        </h1>
        <img src={suite} alt="" className="w-14 sm:w-20" />
      ...
      <div className=" sm:h-32  sm:w-32 h-24 bg-white rounded-lg flex flex-col gap-1 sm:gap-2 justify-center items-center py-1 shadow-lg">
        ...
        <img src={analytics} alt="" className="sm:w-6 w-7 " />
        <div className="flex flex-row gap-1 sm:gap-2 px-2">
          <div className="bg-yellow-400 rounded-full w-[10px] h-[10px] text-transparent"> .</div>
          <div className="bg-yellow-400 rounded-full w-[10px] h-[10px] text-transparent">
            {" "}
      ...
      <div className="sm:w-32 sm:h-32  h-24 bg-white rounded-lg flex flex-col gap-1 sm:gap-2 justify-center items-center py-1 shadow-lg">
        ...
        <img src={firebase} alt="" className="sm:w-9 w-7" />
        <div className="flex flex-row gap-1 sm:gap-2 px-2">
          <div className="bg-yellow-400 rounded-full w-[10px] h-[10px] text-transparent"> .</div>
          <div className="bg-yellow-400 rounded-full w-[10px] h-[10px] text-transparent">
            {" "}
      ...
      <div className="sm:w-32 sm:h-32  h-24 bg-white rounded-lg flex flex-col gap-1 sm:gap-2 justify-center items-center py-1 shadow-lg">
        ...
        <img src={manager} alt="" className="sm:w-9 w-5" />
        <div className="flex flex-row gap-1 sm:gap-2 px-2">
          <div className="bg-yellow-400 rounded-full w-[10px] h-[10px] text-transparent"> .</div>
          <div className="bg-yellow-400 rounded-full w-[10px] h-[10px] text-transparent">
            {" "}
      ...
      <div className="sm:w-32 sm:h-32  h-24 bg-white rounded-lg flex flex-col gap-1 sm:gap-2 justify-center items-center py-1 shadow-lg">
        ...
        <img src={gAds} alt="" className="sm:w-9 w-7" />
        <div className="flex flex-row gap-1 sm:gap-2 px-2">
          <div className="bg-yellow-400 rounded-full w-[10px] h-[10px] text-transparent"> .</div>
          <div className="bg-yellow-400 rounded-full w-[10px] h-[10px] text-transparent">
            {" "}
      ...
      <div className="sm:w-32 sm:h-32  h-24 bg-white rounded-lg flex flex-col gap-1 sm:gap-2 justify-center items-center py-1 shadow-lg">
        ...
        <img src={fAds} alt="" className="sm:w-9 w-7" />
        <div className="flex flex-row gap-1 sm:gap-2 px-2">
          <div className="bg-yellow-400 rounded-full w-[10px] h-[10px] text-transparent"> .</div>
          <div className="bg-yellow-400 rounded-full w-[10px] h-[10px] text-transparent">
            {" "}
      ...
      <div className="sm:w-32 sm:h-32  h-24 bg-white rounded-lg flex flex-col gap-1 sm:gap-2 justify-center items-center py-1 shadow-lg">
        ...
        <img src={crm} alt="" className="sm:w-9 w-7" />
        <div className="flex flex-row gap-1 sm:gap-2 px-2">
          <div className="bg-yellow-400 rounded-full w-[10px] h-[10px] text-transparent"> .</div>
          <div className="bg-yellow-400 rounded-full w-[10px] h-[10px] text-transparent">
            {" "}
      ...
      <div className="sm:w-32 sm:h-32  h-24 bg-white rounded-lg flex flex-col gap-1 sm:gap-2 justify-center items-center py-1 shadow-lg">
        ...
        <img src={zoho} alt="" className="w-7 sm:w-16 my-1" />
        <div className="flex flex-row gap-1 sm:gap-2 px-2">
          <div className="bg-yellow-400 rounded-full w-[10px] h-[10px] text-transparent"> .</div>
          <div className="bg-yellow-400 rounded-full w-[10px] h-[10px] text-transparent">
            {" "}
      ...
      <div className="sm:w-32 sm:h-32  h-24 bg-white rounded-lg flex flex-col gap-1 sm:gap-2 justify-center items-center py-1 shadow-lg">
        ...
        <img src={hubspot} alt="" className="sm:w-9 w-7" />
        <div className="flex flex-row gap-1 sm:gap-2 px-2">
          <div className="bg-yellow-400 rounded-full w-[10px] h-[10px] text-transparent"> .</div>
          <div className="bg-yellow-400 rounded-full w-[10px] h-[10px] text-transparent">
            {" "}
      ...
      <div className="sm:w-32 sm:h-32  h-24 bg-white rounded-lg flex flex-col gap-1 sm:gap-2 justify-center items-center py-1 shadow-lg">
        ...
        <img src={clever} alt="" className="sm:w-9 w-7" />
        <div className="flex flex-row gap-1 sm:gap-2 px-2">
          <div className="bg-yellow-400 rounded-full w-[10px] h-[10px] text-transparent"> .</div>
          <div className="bg-yellow-400 rounded-full w-[10px] h-[10px] text-transparent">
            {" "}
      ...
      <div className="sm:w-32 sm:h-32  h-24 bg-white rounded-lg flex flex-col gap-1 sm:gap-2 justify-center items-center py-1 shadow-lg">
        ...
        <img src={twitter} alt="" className="sm:w-9 w-10" />
        <div className="flex flex-row gap-1 sm:gap-2 px-2">
          <div className="bg-yellow-400 rounded-full w-[10px] h-[10px] text-transparent"> .</div>
          <div className="bg-yellow-400 rounded-full w-[10px] h-[10px] text-transparent">
            {" "}
      ...
      <div className="sm:w-32 sm:h-32  h-24 bg-white rounded-lg flex flex-col gap-1 sm:gap-2 justify-center items-center py-1 shadow-lg">
        ...
        <img src={eplat} alt="" className="sm:w-9 w-5" />
        <div className="flex flex-row gap-1 sm:gap-2 px-2">
          <div className="bg-yellow-400 rounded-full w-[10px] h-[10px] text-transparent"> .</div>
          <div className="bg-yellow-400 rounded-full w-[10px] h-[10px] text-transparent">
            {" "}
