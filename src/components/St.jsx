...
function Portfolio() {
  ...
  return (
    <div className=" bg-gray-100 pt-14 overflow-hidden">
      <div className="flex flex-col gap-12 mx-auto w-[657px] mb-11  relative">
        <div className="flex flex-row shrink-0 gap-x-4">
          <img src={ada} alt="me" className="w-16 shadow-2xl rounded-b-full" />
        ...
        <div className="flex flex-row sm:gap-16 gap-3 w-[430px]  sm:w-[800px]">
          <h1
        ...
        <div
          className={classNames({
            " sm:w-[700px] w-[420px] mx-4  gap-12 flex flex-row flex-nowrap sm:flex-wrap relative z-20":
              isSkillsActive,
        ...
        <div
          ...
          className={classNames({
            "sm:w-[700px] w-[400px] mx-5 gap-12 flex flex-row flex-nowrap sm:flex-wrap relative z-20":
              isToolsActive,
            " hidden": !isToolsActive,
          })}>
          <Tools />
        </div>
        <div className="relative inset-0 bg-orange-200 -top-[400px] left-[540px] opacity-30 rounded-t-full rounded-b-full w-96 h-96  z-0 hidden sm:block" />
      </div>
    </div>
  );
}
